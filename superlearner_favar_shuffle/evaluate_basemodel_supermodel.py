# ================================================================
# evaluate_basemodel_supermodel.py (Superlearner FAVAR-Net v2.2 Shuffle)
# ================================================================
#
# Compare superlearner FAVAR models (RF_FAVAR, RF_SHAP_*) against
...
#
# CLI:
#   python -m superlearner_favar_shuffle.evaluate_basemodel_supermodel \
...
def compare(dataset: str, horizon: int, group: str):
    ...
    # markdown summary
    md_lines = [f"# Superlearner FAVAR-Net v2.2 (Shuffle) vs Basemodel comparison\n"]
...
def parse_args():
    p = argparse.ArgumentParser(description="Compare superlearner FAVAR-Net v2.2 (shuffle) vs basemodel results")
...
def main():
    args = parse_args()
    print("=" * 60)
    print("Superlearner FAVAR-Net v2.2 (Shuffle) vs Basemodel Evaluation")
