...
def get_static_feature_columns(df: pd.DataFrame) -> List[str]:
    """Static feature columns only (excludes GRU forecast features)."""
    return [c for c in df.columns if c not in NON_FEATURE_COLS
